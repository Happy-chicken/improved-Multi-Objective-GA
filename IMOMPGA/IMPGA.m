...
while gen<MAXGEN
    ...
    if mod(gen,20)==0
        fprintf('当前代数%d',gen);
        [Chrom_group, ObjV_group]=integrate(Chrom_group,ObjV_group);
    end
...
xlabel('Generations')
ylabel('Change in optimal solution for each population')
title(['Changes in optimal solutions for each population'])
xlim([1,gen])
...
legend('Change of solution of merging population1','Change of mean vlaue of merging population1','Change of solution of merging population2','Change of mean vlaue of merging population2','Change of solution of merging population3','Change of mean vlaue of merging population3',...
'Change of solution of merging population4','Change of mean vlaue of merging population4','Change of solution of merging population5','Change of mean vlaue of merging population5','MPGA change curve')
xlabel('MPGA generations')
ylabel('Change in optimal solution of MPGA')
